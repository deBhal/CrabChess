...
module.exports = React.createClass ( {
	render: function() {
		...
		return (
			...
			the rules of a game are encoded in the positions of the peices in the game itself.<p/>
			In this example, only the valid moves are determined by the relative position of the player's pieces, and the rest of the rules are stable.
			</span>
		);
	}
} );
